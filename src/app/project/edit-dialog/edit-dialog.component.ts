...
export class EditDialogComponent implements OnInit {
  ...
  onNoClick(): void {
    this.data.details.employeeUserName = this.data.employeelis.filter(
      (x) => x.id === this.data.details.employeeID
    )[0].userName;
    this.data.details.callStatusId = this.data.status.filter(
