...
@Component({
  selector: 'app-mistake-dictionary-type',
  standalone: true,
  ...
  templateUrl: './mistake-dictionary-type.component.html',
  styleUrl: './mistake-dictionary-type.component.scss'
})
export class MistakeDictionaryTypeComponent  implements OnInit{
